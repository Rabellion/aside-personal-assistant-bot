...
function buildAgentPrompt(userPrompt) {
  return [
    ...
    'filling a form - you have Playwright browser tools available over MCP. Use them',
    'rather than saying you cannot browse. That browser keeps a persistent profile, so',
    'Huzaifa stays logged into sites between runs. If you hit a login wall, say so and',
    'tell him to log in once in the browser window that opened; do not guess credentials.',
    '',
